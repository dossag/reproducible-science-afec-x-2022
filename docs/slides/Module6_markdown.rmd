...
--
<ol>
<li> Put references in a plain text file with the extension **.bib**, in **BibTex** format (my advice: use [Mendeley](https://www.mendeley.com/))
</ol>
```bibtex
*@article{Shea2014,
...
For an easy way to insert citations, try the [`citr`](https://github.com/crsh/citr) RStudio add-in. This should be done after installing and restarting R studio.
To install, please use 
```{r}
devtools::install_github("crsh/citr") ## This helps to install citr
```
